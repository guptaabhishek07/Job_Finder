...
import { recemmondedJobLoadAction } from '../redux/actions/recemmondedJobs'
...
const RecemmondedJobs = () => {
    ...
    useEffect(() => {
        dispatch(recemmondedJobLoadAction(page, keyword, cat, location));
...
export default RecemmondedJobs