...
import ResumeRoute from './component/resumeRoute';
                ...
                <ProSidebarProvider>
                    <BrowserRouter>
                        <Routes>
                            ...
                            <Route path='/search/location/:location'  element={<UserRoute>< UserJobsHOC /></UserRoute>} />
                            <Route path='/search/:keyword'  element={<UserRoute>< UserJobsHOC /></UserRoute>} />
                            ...
                            <Route path='/user/jobs' element={<UserRoute>< UserJobsHOC /></UserRoute>} />
                            <Route path='/user/job/:id'  element={<UserRoute>< SingleJobHoc /></UserRoute>} />
                            <Route path='/user/jobHistory' element={<UserRoute>< UserJobsHistoryHOC /></UserRoute>} />
                            <Route path='/user/info' element={<UserRoute>< UserInfoDashboardHOC /></UserRoute>} />
                            <Route path='/user/resume' element={<UserRoute>< ResumeHOC /></UserRoute>} />
